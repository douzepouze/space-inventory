...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for inv in orm.Inventory.objects.all():
            for eq in inv.item.all():
                inv.related_items.add(eq.equiptment)

            for itm in inv.equiptment.all():
                inv.related_items.add(itm.item)

        db.delete_table("items_inventoryequiptment")
